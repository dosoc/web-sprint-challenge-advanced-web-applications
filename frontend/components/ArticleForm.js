...
export default function ArticleForm(props) {
  ...
  const { postArticle, currentArticleId, articles, setCurrentArticleId, updateArticle } = props
  ...
  const onSubmit = evt => {
    evt.preventDefault()
    const editValues = {article_id: currentArticleId, article: values}
    currentArticleId? updateArticle(editValues):postArticle(values)
    setValues(initialFormValues)
    // ✨ implement
